...
//Biller Module
	...
	public final static String Biller_Individualclient_Add = "//input[@id='btnAdd']";
	...
	public final static String Biller_Individualclient_button="//button[text()='Yes']";
	...
	public final static String Biller_ExportBill_Link="//a[contains(text(),'Exported Bills')]";
	...
	public final static String Biller_Invoice_SBilIdList="//select[@name='SubBillerId']";
	...
	public final static String Biller_Invoice_AddBtn="//div[@class='modal-footer']/button[@id='btnAddProduct']";
	public final static String Biller_Invoice_DateInvoc="//input[@name='IssueDate']";
	public final static String Biller_Invoice_DurationID="//select[@name='DurationTypeId']";
	...
	public final static String Biller_Discount_DeleteBtn ="//a[contains(@class,'deleteItem')]";	
...
//	public final static String Biller_Individualclient_Invoice_cName="//span[@id='select2-CustomerId-container']";
	...
	public final static String Admin_InvoiceName= "//td[2]";
	...
	public final static String Admin_SystemMgm_BillerActivateBtn="//a[contains(@href,'BillerActivation')]";
	...
	//Aqarek Application
	public final static String Aqarek_MainMenue = "//android.widget.TextView[@text='الرئيسية']";
	public final static String Aqarek_OTPtextfield1 = "//android.widget.EditText[@index='0']";
	public final static String Aqarek_OTPtextfield2 = "//android.widget.EditText[@index='1']";
	public final static String Aqarek_OTPtextfield3 = "//android.widget.EditText[@index='2']";
	public final static String Aqarek_OTPtextfield4 = "//android.widget.EditText[@index='3']";
	public final static String Aqarek_OTPConfirm = "//android.widget.Button[@text='تأكيد']";
	public final static String Aqarek_MoreMenu = "//android.widget.TextView[@text='المزيد']";
	public final static String Aqarek_EngLanguage = "(//android.widget.ImageView[@index='1'])[2]";
	public final static String Aqarek_HomePagetxt = "//android.widget.TextView[@text='Latest Projects']";
	public final static String Aqarek_EngMoreMenu = "//android.widget.TextView[@text='More']";
	public final static String Aqarek_MorePagetxt = "(//android.widget.TextView[@text='More'])[1]";
	public final static String Aqarek_Termsandcondition = "//android.widget.TextView[@text='Terms And Conditions']";
	public final static String Aqarek_Logout = "//android.widget.TextView[@text='Log out']";
		
			
			
		
			
	public final static String Aqarek_Myrequestmenu = "//android.widget.FrameLayout[@content-desc='طلباتي']/android.widget.FrameLayout/android.widget.ImageView";
	public final static String Aqarek_MobileNotextfield = "//android.widget.EditText[@text='5xx xxx xxx']";
	public final static String Aqarek_SigninBtn = "//android.widget.Button[@text='تسجيل الدخول']";
	public final static String Aqarek_Signin_ErrorMessage = "//android.widget.Toast";
