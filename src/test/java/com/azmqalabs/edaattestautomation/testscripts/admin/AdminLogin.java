...
public class AdminLogin {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminLogin(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication();
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Main Page is Dislayed");	        	
	           	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.Biller_HomePage_Main);
