package com.azmqalabs.edaattestautomation.testscripts.Web;
...
public class BillerUserListSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserListSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserListSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step1 : Verify Biller Applicatison Launched Suceessfully");
	           	Pages.InvokeApplicationPage.launchApplication();
	           	
	        	Pages.InvokeApplicationPage.Chooseoptions();	
	        	
	        	Log.ReportEvent("INFO", "Step2 : Verify Biller Login is Suceessfull");
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify User List Page is Displayed");
	        	Pages.BillerUserMngUserListPage.navigateUserlistPage();
	        
	        	Log.ReportEvent("INFO", "Step4 : Verify Search functionality");
	        	Pages.BillerUserMngUserListPage.verifySearchUser(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step5 : Logout  Suceessful");
	        	Pages.BillerLoginPage.Logout(EdaatOR.Logout);
